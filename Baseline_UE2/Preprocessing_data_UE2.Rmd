...
```{r include=FALSE}
data <- readMat("../data_UE2_600/quadriga_ue2_snr10_avg10TTI_total600TTI_evalinterval1TTI_seed123.mat") 
...
#write.csv(data1,'../data_UE2_600/data_unfold_UE2_600.csv')
```
...
masked_data <- pilot_masking(data1,0.4)
#write.csv(masked_data, '../data_UE2_600/masked_data_UE2_600_04.csv')
```

```{r include=FALSE}
#data <- as.matrix(read.csv('../data_UE2_600/data_unfold_UE2_600.csv', row.names = 1))
...
#write.csv(masked_data, '../data_UE2_600/masked_data_UE2_600_full.csv')
...
#write.csv(X, '../data_UE2_600/X_600_TTI.csv')
#write.csv(y, '../data_UE2_600/y_600_TTI.csv')
