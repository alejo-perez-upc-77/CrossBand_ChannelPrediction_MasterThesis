...
data <- as.matrix(read.csv('../../../../Data/data_90TTI/data_unfold_arg.csv', row.names = 1))
masked_data <- as.matrix(read.csv('../../../../Data/data_90TTI/masked_data_04_arg.csv', row.names = 1))
