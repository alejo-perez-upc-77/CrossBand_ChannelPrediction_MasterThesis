...
data <- as.matrix(read.csv('../../../Data/data_UE1_600/data_unfold_UE1_600.csv', row.names = 1))
masked_data <- as.matrix(read.csv('../../../Data/data_UE1_600/masked_data_UE1_600_04.csv', row.names = 1))
...
plot_pred_vs_true(valid_unmask, missing, valid_pred, 'BPCA UE1', 'red')
...
data <- as.matrix(read.csv('../../../Data/data_UE1_600/2ndpolarisation/data_unfold_2ndpol.csv', row.names = 1))
masked_data <- as.matrix(read.csv('../../../Data/data_UE1_600/2ndpolarisation/masked_data_04_2ndpol.csv', row.names = 1))
