...
plot(data[1,], main= 'Plot of all the MPCs of TTI=1', cex.main=1.5, ylab='Amplitude', xlab='Number of the feature')
abline(v=618, col="red", lwd=3, lty=2)
abline(v=618*2, col="red", lwd=3, lty=2)
abline(v=618*3, col="red", lwd=3, lty=2)

abline(v=309, col="purple", lwd=2, lty=2)
abline(v=309*3, col="purple", lwd=2, lty=2)
abline(v=309*5, col="purple", lwd=2, lty=2)
abline(v=309*7, col="purple", lwd=2, lty=2)
